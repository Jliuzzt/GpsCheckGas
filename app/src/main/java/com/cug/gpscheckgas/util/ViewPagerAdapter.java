 ...
 */
public class ViewPagerAdapter extends PagerAdapter implements MyViewPager.OnPageChangeListener {
    ...
    public ViewPagerAdapter(FragmentManager fragmentManager, List<Fragment> fragments, ContainerViewPager viewPager) {
